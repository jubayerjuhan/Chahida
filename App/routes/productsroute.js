...
const { addProduct, getProducts, getSingleProduct, updateProduct, deleteProduct, getProductWithCategory } = require('../controllers/productController.js');
...
router.route('/product/category').get(authorizeUser, authorizeAdmin, getProductWithCategory);
